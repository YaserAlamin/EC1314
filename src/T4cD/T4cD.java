...
public class T4cD {
	...
	public static void main(String[] args) {
		...
		double r = sc.nextDouble();		// r - fraction of the worst elements from the 
		...
		SimpleGeneticAlghorithm.oneGenerationONEMAX(N, l, s, pm, pc, r, M, u);
	}
...
class SimpleGeneticAlghorithm{
	...
	*/
	public static void oneGenerationONEMAX(int N, int l, int s, double pm, double pc, double r, double M, ArrayList<Double> u){
...
class Replace{
	...
	private int randomMap(double a, double b, double u){
		return (int)Math.round(u * (double)(b - a));
	}
}
class CrossOver{
